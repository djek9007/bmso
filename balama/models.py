...
class Baspa(models.Model):
    """База издательств"""
    name = models.CharField('Наименование издательства', max_length=200)
...
class Language(models.Model):
    ...
    name = models.CharField('Наименование языка обучения', max_length=200)
...
class ClassRoom(models.Model):
    ...
    name = models.CharField('Наименование класса/параллеля', max_length=200)
...
class VersionBook(models.Model):
    ...
    name = models.CharField('Вид учебника', max_length=200)
...
class Book(models.Model):
    ...
    name = models.CharField('Наименование предмета', max_length=200)
